        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                setTimeout(function () {
                    ...
                    // $('.shipping').text(response.shippingcharge);
...
//     // window.location.href = base_url + 'home/getpayment';  // Redirect to payment page
...
// }
  ...
  if (response.ordertype == 'rt') {
        ...
        else if (response.ordertype == 'exp') {
    ...
    function getFilterValuesAndSearch() {
        ...
        loadRetailReport(date, name, phone);
    }
    ...
    function loadRetailReport(date,name,phone) {
