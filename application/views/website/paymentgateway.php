<?php
    ...
    //         "dateTime" => $strCurDate ?? date("d-m-Y H:i:s"),
    //         "token" => $res_msg[5],
    //         "requestType" => "S"
    //     ]
    // );
                ...
                <form method="post" id="form">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="mrctCode"
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="returnUrl"
                                    value='<?php echo $host."://".$_SERVER["HTTP_HOST"].$_SERVER['SCRIPT_NAME'];?>' />
                            </td>
                        </tr>
    ...
    $(document).ready(function() {
        ...
        $("#btnSubmit").click(function(e) {
            ...
            $.ajax({
                ...
                cache: false,
                data: str,
                url: "<?php echo base_url(); ?>home/submitrequest",
                success: function(response) {
                    ...
                    function handleResponse(res) {
                        if (typeof res != 'undefined' && typeof res.paymentMethod !=
                            ...
                            // success block
                        } else if (typeof res != 'undefined' && typeof res.paymentMethod !=
                            'undefined' && typeof res.paymentMethod.paymentTransaction !=
                            'undefined' && typeof res.paymentMethod.paymentTransaction
                            .statusCode != 'undefined' && res.paymentMethod
