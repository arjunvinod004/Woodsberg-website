...
" alt="add new dish" class="add-new-dish__icon" width="23" height="23">
 ...
 ?>
            <div class="product-list__item">
                ...
                <img src="<?php echo base_url('uploads/store/woodsberg.png'); ?>" alt="chapathi" class="product-list__item-img" width="100" height="100">
                ...
                <div class="product-list__item-buttons-block">
                    <div class="product-list__item-buttons-block-one">
                        ...
                        <a 
                            class="product-list__item-buttons-block-btn product-list__item-buttons-block-add-new-stock-btn btn6 edit_store" data-id="<?php echo $val['store_id']; ?>"  data-bs-toggle="modal"  data-bs-target="#edit-store"
                          >
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="row bg-soft-light mb-3 border1 pt-2">
                        <form class="row mt-0 mb-0" id="edit_new_store"
                        ...
                        <input type="hidden" id="hidden_store_id" >
                            ...
                            <div class="mb-2">
                                    ...
                                    value="" type="text"
                                    placeholder="English" name="store_disp_name" id="store_disp_name">
                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                    ...
                                    <input class="form-control"
                                    value="" type="text"
                                    placeholder="English" name="store_name" id="store_name">
                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                    ...
                                    <input class="form-control"
                                    value="" type="text"
                                    placeholder="English" name="store_desc" id="store_desc">
                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                    ...
                                    <input class="form-control"
                                    value="" type="text"
                                    placeholder="English" name="store_address" id="store_address">
                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                    ...
                                    <input class="form-control"
                                    value="" type="text"
                                    placeholder="English" name="store_email" id="store_email">
                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                    ...
                                    <input class="form-control"
                                    value="" type="text"
                                    placeholder="English" name="store_phoneno" id="store_phoneno">
                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                    ...
                                    <input class="form-control"
                                    value="" type="time"
                                    placeholder="English" name="store_opening_time" id="store_opening_time">
                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                    ...
                                    <input class="form-control"
                                    value="" type="time"
                                    placeholder="English" name="store_closing_time" id="store_closing_time">
                            ...
                            <div class="col-md-5">
                                <div class="mb-2">
                                    ...
                                    <input class="form-control"
                                    value="" type="text"
                                    placeholder="English" name="store_gst_tax" id="store_gst_tax">
                            ...
                            <div class="col-md-12 mt-2">
                                <div class="justify-content-center" style="float: right;">
                                    <button class="btn btn-primary w-md"  type="button" id="update_store" >Update</button>
                                </div>
                            </div>
                        </form>
                </div>
