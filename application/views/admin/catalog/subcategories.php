        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <a   data-bs-toggle="modal" data-bs-original-title="Add Country" data-bs-target="#add-subcategory" class="add-new-dish-btn btn1">
                    ...
                    <div class="table-responsive-sm">
                       ...
                       foreach($subcategories as $val){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control update_subcategory_order" style="width:30%;"
                                    ...
                                    <td class="pb-0 pt-0 d-flex">
                                        ...
                                        <a class="btn tblDelBtn pl-0 pr-0 del_subcategory" type="button"
                                            data-bs-toggle="modal" data-id="<?php echo $val->id; ?>"
                                            data-bs-original-title="Delete Category" data-bs-target="#delete-subcategory"><i
        ...
        <div class="modal fade" id="add-subcategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="row mt-0 mb-0" id="addsubcategories"
                    enctype="multipart/form-data" method="post" >
                        ...
                        <div class="col-md-12">
                            <div class="justify-content-center" style="float: right;">
                                <button class="btn btn-primary w-md"  type="button" id="add_subcategory" >Save</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="edit-subcategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                    <div class="row bg-soft-light mb-3 border1 pt-2">
                        <form class="row mt-0 mb-0" id="edit_subcategories"
                        enctype="multipart/form-data" method="post" >
                        ...
                        <input type="hidden" id="hidden_subcategory_id" >
                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                    <label class="form-label" for="default-input">Order</label>
                                    <input type="text" class="form-control" readonly name="subcategory_order" id="subcategory_order"
                            ...
                            <div class="col-md-3">
                                <div class="mb-2">
                                    ...
                                    <textarea style="height: 15px;" name="subcategory_name"  class="form-control"
                                         id="subcategory_name" placeholder="English"
                                                   rows=""></textarea>
                           ...
                           <div class="col-md-4">
                            <div class="mb-2">
                                <label class="form-label" for="default-input">Image</label>
                                 <input  type="hidden" value="" class="form-control"  name="existing_subcategory_userfile" id="existing_subcategory_userfile">
                               <input  type="file" class="form-control" name="subcategory_userfile" id="subcategory_userfile">
                               
                                <img id="preview_subcategory_img" src="" alt="Preview" style="max-width: 150px;">
                            ...
                            <div class="col-md-12">
                                <div class="justify-content-center" style="float: right;">
                                    <button class="btn btn-primary w-md"  type="button" id="save_subcategory" >Update</button>
                                </div>
                            </div>
                        </form>
                </div>
...
<!-- success modal -->
    ...
    <!-- delete user -->
    <div class="modal fade " id="delete-subcategory" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer"><button class="btn btn-primary" type="button" data-bs-dismiss="modal">No</button>
                    <button class="btn btn-secondary" id="yes_subcat_user" type="button" data-bs-dismiss="modal">Yes</button>
                </div>
