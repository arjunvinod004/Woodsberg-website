        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <a   data-bs-toggle="modal" data-bs-original-title="Add Country" data-bs-target="#add-testimonial" class="add-new-dish-btn btn1">
                                ...
                                <tr>
                                    ...
                                    <td class="pb-0 pt-0 d-flex">
                                        ...
                                        <a class="btn tblDelBtn pl-0 pr-0 del_testimonial" type="button"
                                            data-bs-toggle="modal" data-id="<?php echo $val['id']; ?>"
                                            data-bs-original-title="Delete Category" data-bs-target="#delete-testimonial"><i
        ...
        <div class="modal fade" id="add-testimonial" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="row mt-0 mb-0" id="addTestimonial"
                    enctype="multipart/form-data" method="post" >
                        ...
                        <div class="col-md-4">
                            <div class="mb-2">
                                ...
                                value="" type="text"
                                placeholder="Position" name="testimonial_position">
                        ...
                        <div class="col-md-12">
                            <div class="justify-content-center" style="float: right;">
                                <button class="btn btn-primary w-md"  type="button" id="add_testimonial" >Save</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="edit-testimonial" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                    <div class="row bg-soft-light mb-3 border1 pt-2">
                        <form class="row mt-0 mb-0" id="edit_testimonial"
                        enctype="multipart/form-data" method="post" >
                        ...
                        <input type="hidden" id="hidden_testimonial_id" >
                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                    <label class="form-label" for="default-input">name</label>
                                    <input type="text" class="form-control"  name="testimonial_name" id="testimonial_name"
                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                    ...
                                    <input class="form-control"
                                    value="" type="text"
                                    placeholder="English" name="testimonial_position" id="testimonial_position">
                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                    ...
                                    <textarea style="height: 15px;" name="testimonial_desc"  class="form-control"
                                         id="testimonial_desc" placeholder="English"
                                                   rows=""></textarea>
                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                    <label class="form-label" for="default-input">photo</label>
                                    <input  type="hidden" value="" class="form-control"  name="testimonial_image_existing" id="testimonial_image_existing">
                                    <input  type="file" value="" class="form-control" name="testimonial_image" id="testimonial_image">
                            ...
                            <div class="col-md-12">
                                <div class="justify-content-center" style="float: right;">
                                    <button class="btn btn-primary w-md"  type="button" id="save_testimonial" >Update</button>
                                </div>
                            </div>
                        </form>
                </div>
...
<!-- success modal -->
    ...
    <!-- delete testimonials -->
    <div class="modal fade " id="delete-testimonial" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer"><button class="btn btn-primary" type="button" data-bs-dismiss="modal">No</button>
                    <button class="btn btn-secondary" id="yes_delete_testimonial" type="button" data-bs-dismiss="modal">Yes</button>
                </div>
