    ...
    <div class="application-content__container settings-content__container container-fluid">
        ...
        <div class="settings-content__button-blocks owner">
            <a href="<?php echo base_url();?>admin/categories" class="settings-content__btn btn1" ><img
                    ...
                    src="https://img.icons8.com/fluency/30/categorize.png" alt="edit time">Category</a>

             <a href="<?php echo base_url();?>admin/categories/addsubcategory" class="settings-content__btn btn1" ><img
                    class="settings-content__btn-icon"
                    src="https://img.icons8.com/external-sbts2018-outline-color-sbts2018/30/external-category-basic-ui-elements-2.2-sbts2018-outline-color-sbts2018.png" alt="edit time"> SubCategory</a>

             <a href="<?php echo base_url();?>admin/testimonial" class="settings-content__btn btn1" ><img
                    class="settings-content__btn-icon"
                    src="https://img.icons8.com/external-kmg-design-flat-kmg-design/30/external-feedback-feedback-kmg-design-flat-kmg-design.png" alt="edit time">Testimonial</a>
            ...
            <a href="<?php echo base_url();?>admin/user" class="settings-content__btn btn1 adduser" ><img
             ...
             <a href="<?php echo base_url();?>admin/settings/coupon" class="settings-content__btn btn1 addcoupon" ><img
                    class="settings-content__btn-icon"
                    src="https://img.icons8.com/officel/30/cutting-coupon.png"
             ...
             <a href="<?php echo base_url();?>admin/settings/slider" class="settings-content__btn btn1 addcoupon" ><img
                    class="settings-content__btn-icon"
                    src="https://img.icons8.com/ultraviolet/30/sorting-options.png"
                    ...
                    class="settings-content__btn-icon"
                    src="https://img.icons8.com/material-outlined/30/business-contact.png"
                    alt="add/list user">Contact Details</a>


              <a href="<?php echo base_url();?>admin/settings/shipping" class="settings-content__btn btn1 addshipping"  ><img
                    class="settings-content__btn-icon"
                    src="https://img.icons8.com/color/30/free-shipping.png"
                    alt="add/list user">Shipping</a>
