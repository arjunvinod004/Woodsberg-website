<?php
session_start();
// $order_type = $_SESSION['order-type'] ?? null;
...
$customer_mobile = $_GET['cust_phone'] ?? '';
$customer_email = $_GET['cust_email'] ?? '';
...
//         <input type='hidden' name='msg' value='" . htmlspecialchars($_POST['msg'] ?? '') . "'>
//     </form>
//     ";
//     // exit;
// }

// Step 3: Now $_POST['order_id'] is available

// $payment_model = new PaymentModel();
// $payment_model->update_order_id($order_id, $customer_id, $customer_name, $customer_mobile, $customer_email, $total_amount);
    ...
    // echo "<br><br>";
           ...
           if (!isset($_POST['order_id']) && $order_id !== '' && $response_msg[1] === 'success') {
    echo "
    <form id='autoForm' method='POST' action=''>
        <input type='hidden' name='order_id' value='" . htmlspecialchars($order_id) . "'>
        <input type='hidden' name='msg' value='" . htmlspecialchars($_POST['msg'] ?? '') . "'>
    ...
    echo "Order ID from POST: " . ($order_id ?? '');
    // exit;
}
else{
  echo "Order ID from POST: " . '';  
}



$postData = [
    'order_id' => $_GET['order_id'], // or $_POST['order_id']
    'status' => $_POST['msg'] ?? '',
];

$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://woodsberg.com/woodsberg/index.php/Home/handlePaymentResponse');
...
<div class="container">
    <div class="row d-none">
        <div class="col-md-12">
            <h2 class="text-center"> Online Transaction Result : </h2>
            <table class="table" border="1" align="center" cellpadding="2" cellspacing="0"
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center"> Dual-Verification</h2>
            <table class="table" border="1" align="center" cellpadding="2" cellspacing="0"
                style="width: 50%;text-align: center;">
                <thead>
                    <tr class="info">
...
<table class="table" border="1" cellpadding="2" cellspacing="0" style="width: 50%;text-align: center;">
    ...
    <button class="btn btn-primary" type="button" id="back_website">Back
        to
        Website</button>
    ...
    $(document).ready(function() {
        ...
        $('#back_website').on('click', function() {
            // alert("Button clicked!");
            $.ajax({
                url: 'https://woodsberg.com/woodsberg/home/clearPaymentSession',
                type: 'POST',
                dataType: 'json',
                success: function(response) {
                    if (response.success = "success") {
                        window.location.href =
                            "https://woodsberg.com/woodsberg/";
                    }
    ...
    <!-- <tr>
        ...
        <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/php-checkoutjs/reconciliation.php"; ?>'
                target="_blank">GO TO RECONCILIATION</a></td>
        <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/php-checkoutjs/refund.php"; ?>' target="_blank">GO
                TO REFUND</a></td>
        <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/php-checkoutjs/emandate-si/mandate-verification.php"; ?>'
                target="_blank">GO TO MANDATE VERIFICATION</a></td>
        <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/php-checkoutjs/emandate-si/transaction-scheduling.php"; ?>'
                target="_blank">GO TO TRANSACTION SCHEDULING</a></td>
        <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/php-checkoutjs/emandate-si/transaction-verification.php"; ?>'
                target="_blank">GO TO TRANSACTION VERIFICATION</a></td>
        <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/php-checkoutjs/emandate-si/mandate-deactivation.php"; ?>'
                target="_blank">GO TO MANDATE DEACTIVATION</a></td>
        <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/php-checkoutjs/emandate-si/stop-payment.php"; ?>'
                target="_blank">GO TO STOP PAYMENT</a></td>
        </tr> -->
</table><br>
...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo $host."://".$_SERVER["HTTP_HOST"].'/php-checkoutjs/assets/css/bootstrap.min.css';?>">
    ...
    <!-- <script src="<?php echo $host."://".$_SERVER["HTTP_HOST"].'/php-checkoutjs/assets/js/bootstrap.min.js';?>">
    </script> -->
                ...
                <form method="post" id="form">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" id="myamount" name="amount" value="" /></td>
                        </tr>
                        <tr class="hid">
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="orderID" value="<?php echo $order_id; ?>">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" name="mobNo"
                                    value="<?php echo $customer_mobile ?>" /></td>
                        </tr>
                        <tr>
                            <td><label>Email</label></td>
                            <td><input type="text" class="form-control" name="email"
                                    value="<?php echo $customer_email ?>" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr class="hid">
                            ...
                            <td><input type="text" name="currency"
                                    value="<?php if(isset($mer_array['currency'])){echo $mer_array['currency'];} ?>" />
                            </td>
                        </tr>
                        <tr class="hid">
                            <td><label>SALT</label></td>
                            <td><input type="text" name="SALT"
                                    value="<?php if(isset($mer_array['salt'])){echo $mer_array['salt'];} ?>" /></td>
                        </tr>


                        <?php 
                        $order_id = $order_id ?? ''; // Make sure $orderno is defined before this
$returnUrl = $host . "://" . $_SERVER["HTTP_HOST"] . $_SERVER['SCRIPT_NAME'] . "?order_id=" . $order_id;?>
                        <tr class="hid">
                            <td><label>Return url</label></td>
                            <td><input type="text" name="returnUrl" value='<?php echo $returnUrl ?>' />
                            </td>
                        </tr>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        function handleResponse(res) {
                            if (typeof res != 'undefined' && typeof res.paymentMethod !=
                                'undefined' && typeof res.paymentMethod
                                .paymentTransaction !=
                                'undefined' && typeof res.paymentMethod.paymentTransaction
                                .statusCode != 'undefined' && res.paymentMethod
                                .paymentTransaction.statusCode == '0300') {
                                // success block
                            } else if (typeof res != 'undefined' && typeof res
                                .paymentMethod !=
                                'undefined' && typeof res.paymentMethod
                                .paymentTransaction !=
                                'undefined' && typeof res.paymentMethod.paymentTransaction
                                .statusCode != 'undefined' && res.paymentMethod
                                .paymentTransaction.statusCode == '0398') {
                                // initiated block
                            } else {
                                // error block
                            }
                        ...
                        var configJson = {
                            ...
                            'consumerData': {
                                ...
                                'consumerId': obj['data'][
                                    8
                                ], //Your unique consumer identifier to register a eMandate/eNACH
                                ...
                                'accountNo': obj['data'][
                                    11
                                ], //Pass this if accountNo is captured at merchant side for eMandate/eNACH
                                'accountHolderName': obj['data'][
                                    16
                                ], //Pass this if accountHolderName is captured at merchant side for ICICI eMandate & eNACH registration this is mandatory field, if not passed from merchant Customer need to enter in Checkout UI.
                                'ifscCode': obj['data'][
                                    17
                                ], //Pass this if ifscCode is captured at merchant side.
                                'accountType': obj['data'][
                                    18
